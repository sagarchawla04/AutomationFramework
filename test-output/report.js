...
formatter.step({
  "name": "user enters the login credentials from \"test.json\" file",
  "keyword": "And "
});
formatter.match({
  "location": "Steps.userEntersTheLoginCredentialsFromFile(String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "Steps.user_can_view_confirmation_message()"
});
formatter.result({
  "status": "passed"
});
